...
const HEXAGRAM_MAP: Record<string, string> = {
  ...
  '010111': '水天需', '111010': '天水讼',
  '000010': '地水师', '010000': '水地比',
  '110111': '风天小畜', '111011': '天泽履',
  '000111': '地天泰', '111000': '天地否',
  '111101': '天火同人', '101111': '火天大有',
  '000100': '地山谦', '001000': '雷地豫',
  '011001': '泽雷随', '100110': '山风蛊',
  '000011': '地泽临', '110000': '风地观',
  '101001': '火雷噬嗑', '100101': '山火贲',
  '100000': '山地剥', '000001': '地雷复',
  '111001': '天雷无妄', '100111': '山天大畜',
  '100001': '山雷颐', '011110': '泽风大过',
  '010010': '坎为水', '101101': '离为火',
  '011010': '泽山咸', '010110': '水山蹇',
  '001001': '雷水解', '110110': '风火家人',
  '011100': '泽火革', '001110': '雷火丰',
  '010100': '水山蹇', '001010': '雷水解',
  '110001': '风雷益', '100011': '山泽损',
  '111100': '天泽履', '001111': '雷天大壮',
  '101000': '火地晋', '000101': '地火明夷',
  '101011': '火泽睽', '110101': '风火家人',
  '010011': '水泽节', '110010': '风泽中孚',
  '001011': '雷山小过', '110100': '风山渐',
  '101100': '火山旅', '001101': '雷水解',
  '011000': '泽地萃', '000110': '地风升',
  '011011': '泽天夬',
