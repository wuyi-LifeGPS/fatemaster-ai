      ...
      {shuffling && (
        <div className="flex flex-col items-center justify-center py-16 gap-4">
          <div className="relative w-20 h-28">
            <div className="absolute inset-0 rounded-xl bg-gradient-to-br from-[#c9a96e]/20 to-[#6b5b95]/20 border border-white/10 animate-pulse" />
              ...
              <div key={i} className="text-center">
                ...
                <button
                  ...
                  className={`w-full aspect-[2/3] rounded-xl border transition-all duration-500 relative overflow-hidden ${
                    revealed.includes(i)
                      ? 'bg-gradient-to-br from-[#c9a96e]/10 to-[#6b5b95]/10 border-[#c9a96e]/30 animate-fade-in-scale'
