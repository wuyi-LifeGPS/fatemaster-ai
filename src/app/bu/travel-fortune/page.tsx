    ...
    <div className="px-4 pt-4 pb-24 animate-fade-in">
      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          ...
          <p className="text-moonly-text-muted text-xs">出行吉时，平安顺遂</p>
        </div>
      </div>
      ...
      {result && (
        <div className="space-y-4">
          <div className="moonly-card p-6 text-center">
            ...
            <div className="mt-4">
              <div className="text-moonly-text-muted text-xs mb-1">出行指数</div>
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div className="moonly-card p-4 text-center">
              <div className="text-moonly-text-muted text-xs mb-1">适宜类型</div>
