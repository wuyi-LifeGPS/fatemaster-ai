...
function getDailySentence(): typeof DAILY_SENTENCES[0] {
  ...
  return (
    <div className="moonly-card p-4 animate-fade-in">
      <div className="flex items-center gap-2 mb-3">
        <span className="text-lg">{sentence.emoji}</span>
        <h3 className="text-gold text-sm font-semibold">每日一句</h3>
      </div>

      <div className="text-center py-2">
        <p className="text-white/80 text-sm leading-relaxed">{sentence.text}</p>
      </div>
    </div>
  )
}
